...
// Charte Agence Mantu 2026 — Space Grotesk (typo du système)
...
export default function RootLayout({
  ...
  return (
    <html lang="fr" className={`${geist.variable} ${geistMono.variable} ${spaceGrotesk.variable} h-full antialiased`}>
